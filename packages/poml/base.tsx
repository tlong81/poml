...
export interface ContentMultiMediaToolRequest {
  type: 'application/vnd.poml.toolrequest+json';
  text: string; // Tool input parameters in JSON format
...
export interface ContentMultiMediaToolResponse {
  type: 'application/vnd.poml.toolresponse+json';
  text: string; // Tool output parameters in JSON format
